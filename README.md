...
ပထမဆုံး လေ့လာတဲ့သူတွေအတွက်က follow လိုက်ဖို့ ခက်တာကြောင့် "ဆရာက" ဆိုတဲ့ စာကြောင်းတို့လေးကိုပဲ graph အနေနဲ့ မြင်ပြီး best path သို့မဟုတ် shortest path ကို ဘယ်လို တွက်သလဲ ဆိုတာကို စဉ်းစားကြည့်ကြရအောင်။ Fig.1 ကိုတည်ပြီးတော့ ရှင်းသွားပါမယ်။ ပုံမှာ ပြထားသလိုပါပဲ graph မှာက node တွေရှိမယ်။ အဲဒီ node တွေကို ဆက်နေတဲ့ path တွေလည်း ရှိပါလိမ့်မယ်။ node တစ်ခုချင်းစီက ဖြစ်နိုင်တဲ့ စာလုံး (i.e. word) တွေကို ကိုယ်စားပြုပြီးတော့ path တစ်ခုချင်းစီက စာကြောင်းကို segmentation လုပ်သွားမယ့် လမ်းကြောင်းတွေ ဖြစ်ပါတယ်။ Path တစ်ခုစီမှာ ဥပမာအနေနဲ့ ရေးပြထားတဲ့ path weight တွေက လက်ရှိ စာလုံးဖြတ်ဖို့လုပ်နေတဲ့ စာကြောင်းရဲ့  unigram negative log property တွေပါ။
